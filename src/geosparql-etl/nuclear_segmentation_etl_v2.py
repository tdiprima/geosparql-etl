...
python nuclear_segmentation_etl_v2.py --workers 32

# Resume with parallelism
python nuclear_segmentation_etl_v2.py --start-from "TCGA-A7-A0CD-01Z-00-DX1.F045B9C8-049C-41BF-8432-EF89F236D34D.svs" --workers 32

# Check help
python nuclear_segmentation_etl_v2.py --help
"""
